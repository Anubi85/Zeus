...
{
    /// <summary>
    /// Makes <see cref="KeyboardHook"/> to fire <see cref="KeyboardHook.KeyStatusChanged"/> events
    /// only for keys defined in <see cref="KeyCodes"/>.
    /// </summary>
    public sealed class KeyProcessFilter : IKeyboardHookFilter
    {
        ...
        /// <summary>
        /// Create a new instance of <see cref="KeyProcessFilter"/> and initialize its internal structures.
        /// </summary>
        public KeyProcessFilter()
        {
        ...
        /// must generate the <see cref="KeyboardHook.KeyStatusChanged"/> event.
        /// </summary>
